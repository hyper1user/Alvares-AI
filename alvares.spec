...
a = Analysis(
    ...
    datas=[
        ...
        ('templates/rozp_Variant_C.docx', 'templates'),
        ('templates/rozp_Variant_D.docx', 'templates'),
        ('templates/rozp_Variant_E.docx', 'templates'),
        ('templates/rozp_Variant_F.docx', 'templates'),
        ('templates/rozp_Variant_G.docx', 'templates'),
        ('alvares.ico', '.'),
        ('alvares_icon.png', '.'),
        ('alvares_busy.png', '.'),
    ],
